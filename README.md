...
| 3  | Bloom's Taxonomy       |               | Pre-loaded & Manipulable: C(6 - Knowledge, Comprehension, Application, Analysis, Synthesis, Evaluation), P(7 - Perception, Set, Guided Response, Mechanism, Complex Overt Response, Adaptation, Orgination), A(5 - Receiving, Responding, Valuing, Organising, Characterising)     | Done   |
